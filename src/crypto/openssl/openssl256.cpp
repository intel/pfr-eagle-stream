...
#ifdef SPECIFY_KEY
{
    ...
    const char* specified_privkey_hex_str = "c51e4753afdec1e6b6c6a5b992f43f8dd0c7a8933072708b6522468b2ffb06fd";
...
//     BN_hex2bn(&res,"3D79F601620A6D05DB7FED883AB8BCD08A9101B166BC60166869DA5FC08D936E");
    ...
    printf("Pubkey KALEN:\n");
    printf("\tCX : ");
    for (int i = 2; i < (2 + 64); i++) // 1 byte 0x4C, 256/8 bytes for X coordinate, 256/8 bytes for Y coordinate
    {
        printf("%c", c[i]);
    }
    printf("\n");
    ...
    printf("\tCY : ");
    for (int i = 2 + 64; i < (2 + 64 + 64); i++) // 1 byte 0x40, 96 bytes for X coordinate, 96 bytes for Y coordinate
    {
        printf("%c", c[i]);
    }
    printf("\n");
