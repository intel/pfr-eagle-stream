...
TEST_F(AttestationFlowNegTest, test_cfm_hash_change_after_corruption_256)
{
    /*
     * Test Preparation
     */
    ...
    // Track the cfm1 hash
    alt_u32 cfm1_hash_before_corruption[SHA256_LENGTH/4] = {0};
...
TEST_F(AttestationFlowNegTest, test_pub_key_0_change_after_corruption_256)
{
    /*
     * Test Preparation
     */
    ...
    alt_u32 pubkey_0_before_corruption[SHA256_LENGTH/2] = {0};
...
TEST_F(AttestationFlowNegTest, test_priv_key_1_change_after_corruption_256)
{
    /*
     * Test Preparation
     */
    ...
    alt_u32 privkey_1_before_corruption[SHA256_LENGTH/4] = {0};
...
TEST_F(AttestationFlowNegTest, test_cdi1_change_after_corruption_256)
{
    /*
     * Test Preparation
     */
    ...
    // Track the cdi 1
    alt_u32 cdi1_before_corruption[SHA256_LENGTH/4] = {0};
...
TEST_F(AttestationFlowNegTest, test_pub_key_1_change_after_corruption_256)
{
    /*
     * Test Preparation
     */
    ...
    alt_u32 pubkey_1_before_corruption[SHA256_LENGTH/2] = {0};
...
TEST_F(AttestationFlowNegTest, test_prep_attestation_256_alter_priv_key)
{
    /*
     * Test Preparation
     */
    ...
    prep_for_attestation(cfm0_uds_ptr, CRYPTO_256_MODE);
