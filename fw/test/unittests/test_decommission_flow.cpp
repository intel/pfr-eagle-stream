 ...
 * @brief Execute the decommission flow in the manner that user would normally do.
 */
TEST_F(DecommissionFlowTest, test_decommission_and_check_cert)
{
    /*
     * Test Preparation
     */
 ...
 * @brief Execute the decommission flow in the manner that user would normally do.
 */
TEST_F(DecommissionFlowTest, test_decommission_and_check_keys)
{
    /*
     * Test Preparation
     */
    ...
    // Comes from key/cert generation and decommision
 ...
 * @brief Execute the decommission flow in the manner that user would normally do.
 */
TEST_F(DecommissionFlowTest, test_decommission_and_reprovision_attestation_command_without_afm)
{
    /*
     * Test Preparation
     */
    ...
    // Expect AFM authentication error as the BMC image does not contain AFM(s)
 ...
 * @brief Execute the decommission flow in the manner that user would normally do.
 */
TEST_F(DecommissionFlowTest, test_decommission_and_reprovision_attestation_command_with_afm)
{
    /*
     * Test Preparation
     */
    // Load BMC flash with AFM
    ...
    // Expect no AFM authentication error
    EXPECT_EQ(read_from_mailbox(MB_MAJOR_ERROR_CODE), alt_u32(0));
    EXPECT_EQ(read_from_mailbox(MB_MINOR_ERROR_CODE), alt_u32(0));
}
