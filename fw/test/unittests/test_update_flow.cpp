...
/**
 * @brief This test sends a BMC update intent that requests CPLD, PCH, BMC active update at once
 */
TEST_F(UpdateFlowTest, test_oob_bmc_pch_cpld_active_update_at_once)
{
    ...
    ut_send_in_update_intent_once_upon_boot_complete(
    		MB_BMC_UPDATE_INTENT_PART1, MB_UPDATE_INTENT_PCH_ACTIVE_MASK | MB_UPDATE_INTENT_BMC_ACTIVE_MASK | MB_UPDATE_INTENT_CPLD_ACTIVE_MASK);
...
TEST_F(UpdateFlowTest, test_oob_bmc_active_pch_recovery_cpld_active_update_at_once)
{
    ...
    // Send the active update intent
    ut_send_in_update_intent_once_upon_boot_complete(
    		MB_BMC_UPDATE_INTENT_PART1, MB_UPDATE_INTENT_PCH_RECOVERY_MASK | MB_UPDATE_INTENT_BMC_ACTIVE_MASK | MB_UPDATE_INTENT_CPLD_ACTIVE_MASK);
    ut_run_main(CPLD_CFM1, true);
...
TEST_F(UpdateFlowTest, test_oob_bmc_pch_cpld_recovery_update_at_once)
{
    ...
    SYSTEM_MOCK::get()->load_to_flash(SPI_FLASH_BMC, SIGNED_CAPSULE_PCH_V03P12_FILE,
            SIGNED_CAPSULE_PCH_V03P12_FILE_SIZE, get_ufm_pfr_data()->bmc_staging_region + BMC_STAGING_REGION_PCH_UPDATE_CAPSULE_OFFSET);
    SYSTEM_MOCK::get()->load_to_flash(SPI_FLASH_BMC, SIGNED_CAPSULE_CPLD_B490_3_FILE,
            SIGNED_CAPSULE_CPLD_B490_3_FILE_SIZE, get_ufm_pfr_data()->bmc_staging_region + BMC_STAGING_REGION_CPLD_UPDATE_CAPSULE_OFFSET);
    ...
    alt_u32* cpld_update_capsule = new alt_u32[SIGNED_CAPSULE_CPLD_B490_3_FILE_SIZE/4];
    SYSTEM_MOCK::get()->init_x86_mem_from_file(SIGNED_CAPSULE_CPLD_B490_3_FILE, cpld_update_capsule);
