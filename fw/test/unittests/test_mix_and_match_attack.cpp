...
TEST_F(UpdateFlowMixAndMatchAttackTest, test_send_bmc_active_update_with_cpld_capsule)
{
    ...
    ut_send_in_update_intent(MB_BMC_UPDATE_INTENT_PART1, MB_UPDATE_INTENT_BMC_ACTIVE_MASK);
    ...
    EXPECT_EQ(SYSTEM_MOCK::get()->get_t_minus_1_bmc_only_counter(), alt_u32(MAX_FAILED_UPDATE_ATTEMPTS_ALLOWED));
...
TEST_F(UpdateFlowMixAndMatchAttackTest, test_send_bmc_active_update_with_pch_pfm)
{
    ...
    // Load the fw update capsule to staging region in flash
    SYSTEM_MOCK::get()->load_to_flash(SPI_FLASH_BMC, SIGNED_PFM_PCH_FILE,
            SIGNED_PFM_PCH_FILE_SIZE, get_ufm_pfr_data()->bmc_staging_region);
...
TEST_F(UpdateFlowMixAndMatchAttackTest, test_send_bmc_recovery_update_with_cpld_capsule)
{
    ...
    // Send the active update intent
    ut_send_in_update_intent(MB_BMC_UPDATE_INTENT_PART1, MB_UPDATE_INTENT_BMC_RECOVERY_MASK);
...
TEST_F(UpdateFlowMixAndMatchAttackTest, test_send_oob_pch_active_update_with_cpld_capsule)
{
    ...
    // Send the active update intent
    ut_send_in_update_intent(MB_BMC_UPDATE_INTENT_PART1, MB_UPDATE_INTENT_PCH_ACTIVE_MASK);
...
TEST_F(UpdateFlowMixAndMatchAttackTest, test_send_oob_pch_recovery_update_with_pch_pfm)
{
    ...
    // Send the active update intent
    ut_send_in_update_intent(MB_BMC_UPDATE_INTENT_PART1, MB_UPDATE_INTENT_PCH_RECOVERY_MASK);

    // Load the fw update capsule to staging region in flash
    SYSTEM_MOCK::get()->load_to_flash(SPI_FLASH_BMC, SIGNED_PFM_PCH_FILE,
            SIGNED_PFM_PCH_FILE_SIZE, get_ufm_pfr_data()->bmc_staging_region + BMC_STAGING_REGION_PCH_UPDATE_CAPSULE_OFFSET);
...
TEST_F(UpdateFlowMixAndMatchAttackTest, test_send_oob_cpld_recovery_update_with_pch_pfm)
{
    ...
    // Load the fw update capsule to staging region in flash
    SYSTEM_MOCK::get()->load_to_flash(SPI_FLASH_BMC, SIGNED_PFM_PCH_FILE,
            SIGNED_PFM_PCH_FILE_SIZE, get_ufm_pfr_data()->bmc_staging_region + BMC_STAGING_REGION_CPLD_UPDATE_CAPSULE_OFFSET);
...
TEST_F(UpdateFlowMixAndMatchAttackTest, test_send_ib_pch_active_update_with_cpld_capsule)
{
    ...
    // Send the active update intent
    ut_send_in_update_intent(MB_PCH_UPDATE_INTENT_PART1, MB_UPDATE_INTENT_PCH_ACTIVE_MASK);
    ...
    EXPECT_EQ(SYSTEM_MOCK::get()->get_t_minus_1_counter(), alt_u32(1));
    EXPECT_EQ(SYSTEM_MOCK::get()->get_t_minus_1_bmc_only_counter(), alt_u32(0));
    EXPECT_EQ(SYSTEM_MOCK::get()->get_t_minus_1_pch_only_counter(), alt_u32(MAX_FAILED_UPDATE_ATTEMPTS_ALLOWED));
...
TEST_F(UpdateFlowMixAndMatchAttackTest, test_send_ib_pch_recovery_update_with_bmc_capsule)
{
    ...
    // Send the active update intent
    ut_send_in_update_intent(MB_PCH_UPDATE_INTENT_PART1, MB_UPDATE_INTENT_PCH_RECOVERY_MASK);
