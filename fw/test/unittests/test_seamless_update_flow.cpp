...
class SeamlessUpdateFlowTest : public testing::Test
{
public:
...
/**
 * @brief This test exercises the in-band happy path of Seamless update flow, with BIOS FV capsule.
 */
TEST_F(SeamlessUpdateFlowTest, test_seamless_update_ib_happy_path)
{
    /*
     * Test Preparation
     */
...
/**
 * @brief This test exercises the out-of-band happy path of Seamless update flow, with BIOS FV capsule.
 */
TEST_F(SeamlessUpdateFlowTest, test_seamless_update_oob_happy_path)
{
    /*
     * Test Preparation
     */
 ...
 */
TEST_F(SeamlessUpdateFlowTest, test_ib_seamless_update_static_plus_dynamic)
{
    /*
     * Test Preparation
     */
    ...
    // Send the Seamless update intent
    ut_send_in_update_intent_once_upon_boot_complete(MB_PCH_UPDATE_INTENT_PART2, MB_UPDATE_INTENT_PCH_FV_SEAMLESS_MASK);
    ut_send_in_update_intent_once_upon_boot_complete(MB_PCH_UPDATE_INTENT_PART1, MB_UPDATE_INTENT_UPDATE_DYNAMIC_MASK);
 ...
 * and UPDATE_DYNAMIC bit set in update intent.
 */
TEST_F(SeamlessUpdateFlowTest, test_oob_seamless_update_static_plus_dynamic)
{
    /*
     * Test Preparation
     */
    ...
    // Send the Seamless update intent
    ut_send_in_update_intent_once_upon_boot_complete(MB_BMC_UPDATE_INTENT_PART2, MB_UPDATE_INTENT_PCH_FV_SEAMLESS_MASK);
    ut_send_in_update_intent_once_upon_boot_complete(MB_BMC_UPDATE_INTENT_PART1, MB_UPDATE_INTENT_UPDATE_DYNAMIC_MASK);
...
/**
 * @brief This test exercises the out-of-band path of Seamless update flow, with BIOS FV capsule.
 * However, BMC did not clear the reset bit after update.
 */
TEST_F(SeamlessUpdateFlowTest, test_seamless_update_oob_bmc_reset)
{
    /*
     * Test Preparation
     */
    ...
    // Send the Seamless update intent
    ut_send_in_update_intent_once_upon_boot_complete(MB_BMC_UPDATE_INTENT_PART2, MB_UPDATE_INTENT_BMC_SEAMLESS_RESET_MASK | MB_UPDATE_INTENT_PCH_FV_SEAMLESS_MASK);
    ...
    // Seamless update should not require T-1 entry
    // BMC should be reset by cpld due not clearing the reset bit
