 ...
 */
TEST_F(RecoveryFlowTest, test_pch_fw_spi_read_failure_first_authentication_on_active_and_recovery_firmware)
{
    /*
     * Preparation
     */
    ...
    // Block spi read during flash authentication
    // This only block access on first authentication
    ut_block_spi_read_access_once_during_pch_auth();
    ...
    // Call this before switching spi flash as internally switched
    ...
    // Expect no recovery as Nios re-authenticate if active and recovery firmware is corrupted
 ...
 * mechanism in T-1 authentication step.
 */
TEST_F(RecoveryFlowTest, test_bmc_fw_spi_read_failure_first_authentication_on_active_and_recovery_firmware)
{
    /*
     * Preparation
     */
    ...
    // Block spi read during flash authentication
    // This only block access on first authentication
    ut_block_spi_read_access_once_during_bmc_auth();
