...
##############################################################################
# Build module specific main_t3
##############################################################################
TEST_EXE_NAMES += $(MODULE_NAME)_main_t3
$(MODULE_NAME)_main_t3 : MODULE_NAME := $(MODULE_NAME)
$(MODULE_NAME)_main_t3 : $(addprefix $($(MODULE_NAME)_WORK_DIR)/,main.obj $(MAIN_SYSTEM_OBJS_LIST) $(MAIN_T3_UNITTEST_OBJS_LIST) $(GTEST_OBJ_LIST))
	$(global_exe_link)

build-$(MODULE_NAME) : $(MODULE_NAME)_main_t3

run_$(MODULE_NAME)_main_t3 : MODULE_NAME := $(MODULE_NAME)
run_$(MODULE_NAME)_main_t3 : $(MODULE_NAME)_main_t3
	$(info Preparing to run $@)
	# Clear the LD_LIBRARY_PATH before running
	LD_LIBRARY_PATH=$(GCC_ROOTDIR)/lib64:$(BOOST_ROOT_DIR)/lib ./$(MODULE_NAME)_main_t3 | tee $(MODULE_NAME)_main_t3_out.txt
