...
public:
    ...
    enum class CODE_BLOCK_TYPES
    {
        ...
        SKIP_ATTESTATION_AND_END_T0_OPERATIONS_AFTER_50_ITERS,
    ...
    // Page erase cycle
    alt_u32 get_ufm_erase_page_counter() {return m_ufm_erase_page_counter;}
    void incr_m_ufm_erase_page_counter() {m_ufm_erase_page_counter++;}
    ...
    void incr_flag() {m_change_data++;}
    alt_u32 mock_replace_key() {return m_change_data;}
    ...
    void force_mock_entropy_error();

#if defined(GTEST_ATTEST_384) || defined(GTEST_ATTEST_256)
    void stage_next_spdm_message();
...
private:
    ...
    // A counter to track erase cycle
    alt_u32 m_ufm_erase_page_counter = 0;

    // Flag
    alt_u32 m_change_data = 0;
